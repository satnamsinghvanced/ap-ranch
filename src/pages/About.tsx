            ...
            <div className="container-fluid">
              <div className="row">
                <div className="col-ms-12 p-0">
                  ...
                  <div className="about-football-banner-open">
                      ...
                      <div className="row">
                          ...
                          <div className="col-lg-6 mt-5">
                              <p className="about-accoridan-text">
                                <b> At AP Ranch,</b> we believe that football is more than just a game; it’s an opportunity to develop important life skills like teamwork, leadership, and perseverance. By providing a supportive and inclusive environment, we aim to help our student athletes grow into confident and well-rounded individuals who are prepared to succeed in all aspects of life.
                              </p>
                          </div>
                          <div className="col-lg-5 mt-5">
                            <div className="about-accoridan-services">
                                <h3 className="about-accoridan-services-heading">Services</h3>
                                <p className="about-accoridan-services-para">Private One-On-One Training<br></br>
                                    Small Group Training<br></br>Offensive Mentorship/Consulting<br></br>
                                    Film Breakdown/ Game Analysis
                                      
                                </p>
                                <button className="explore-btn-transparent">explore</button>
                            </div>
                          </div>
                      </div>
                    </div>
