...
import { Items } from "../components/consts/const";
    ...
    <div>
      ...
      <section className="sport-contant-us">
        <div className="max-width-1050 mx-auto text-center ">
          <p>
            Our basketball program offers everything you need - being a one stop
            shop to success. Working with individual athletes and teams at all
            levels from beginner to professional. We value & preach
            accountability, respect, teamwork, skillwork, and the benefit of
            hard work, both on and off the court - Everything that goes into
            performing at the highest level in every aspect of life. Our goal
            and mission is to create the complete student athlete, one player at
            a time! 
          </p>
