            ...
            <div className="contact-form">
              ...
              <div className="contact-form-inner">
                  <form action="">
                    ...
                    <div className="d-flex flex-column">
                       <label htmlFor="" className="contact-form-label">Phone number</label>
                       <input type="text" className="contact-from-input"  />
                    </div>

                    <div className="d-flex flex-column">
                       <label htmlFor="" className="contact-form-label">What are you contacting about?</label>
                       <input type="text" className="contact-from-input"  />
                    </div>
                    <div className="d-flex flex-column">
                       <label htmlFor="" className="contact-form-label">Comments</label>
